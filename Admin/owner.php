    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- DataTables -->
          ...
          <a href="index.php">Back</a>House Owner</div>
          <div class="card-body">
          ...
          $sel = "SELECT * FROM household_head INNER JOIN purok ON household_head.prk_id= purok.prk_id WHERE house_status LIKE '%Owner'";
					$selqsl = mysqli_query($connection,$sel);
						...
						while($i = $selqsl -> fetch_array()){
						  ...
						  $db_ucfirst_head = ucfirst($i['house_status']);
						...
						echo "<td>$db_ucfirst_head</td>";
							echo "<Td colspan='2'>
							    <center>
							   <a href='edit.php?resident_id=$i[0]'data-toggle='tooltip' title='Edit'><i class='fa fa-user-edit' style='font-size:20px'></i></a>|
