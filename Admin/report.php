      ...
      <div class="container-fluid">
        ...
        <!-- DataTables Example -->
         <div class="card mb-3">
          ...
          $sel = "SELECT * FROM reports";
					$selqsl = mysqli_query($connection,$sel);
						while($i = $selqsl -> fetch_array()){
						  $ucsession = $i['username'];
						  $remark = $i['remarks'];
						  $ucfirst_session = ucfirst($ucsession);
						  $ucfirst_remark = ucfirst($remark);
							echo "<tr>";
				    	echo "<td>$i[3]</td>";
						echo "<td>$ucfirst_session</td>";
						echo "<td>$ucfirst_remark</td>";
