    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <a href="index.php">Dashboard</a>  View All Resident's
            </div>
          <div class="card-body">
                 ...
                 $sel = "SELECT * FROM household_head INNER JOIN purok ON purok.prk_id=household_head.prk_id ";
					$selqsl = mysqli_query($connection,$sel);
						...
						echo "<td><center style='padding-top:40px;'>$ucnickname</centeR></td>";
							echo "<td><center style='padding-top:40px;'>$db_birthdate</centeR></td>";
								echo "<td><center style='padding-top:40px;'>$gender</centeR></td>";
