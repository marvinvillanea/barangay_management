    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <a href="index.php">Back</a>  View Household Head
            </div>
          <div class="card-body">
          ...
          $sel = "SELECT * FROM household_head INNER JOIN purok ON household_head.prk_id= purok.prk_id WHERE house_head LIKE '%house head'";
