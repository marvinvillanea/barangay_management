...
$get_record_num = mysqli_num_rows($get_record);
    ...
    if ($get_record_num > 0 ){
        ...
        $query_update =  mysqli_query($connection, "UPDATE barangay_officials SET brg_year_declered='$declered' WHERE brg_id = '$brg_cap_id' ");
        
        if ($query_update === TRUE){
           mysqli_query($connection, "INSERT INTO reports(username,remarks,report_datetime,user_id) VALUES ('$db_first_name_session','Barangay Captain $fullname has been succesfully updated',NOW(),'$db_user_id');");
        ...
        <form method ="POST">
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="date" name="declered" id="lastName" class="form-control" value="<?php echo $db_year_declered ;?>" placeholder="Last name">
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="text" name="date_end" id="firstName" class="form-control" value="<?php echo $db_position; ?>" utofocus="autofocus">
