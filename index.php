...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header"><center>Gimangpang Management System</center></div>
      <div class="card-body">
       <center><img src="logo_cell.jpg" id="image" style="width: 180px!important;border:20px;"></img></center>
        <form method="POST" action="index.php">
          <div class="form-group">
            <div class="form-label-group">
              <input type="email" name="username" id="inputEmail" class="form-control" placeholder="Username" autofocus="autofocus">
    ...
    if(isset($_POST["btnlogin"])){
        if(empty($_POST["username"])){ 
          $usernameErr = " Email is required";
            echo "<script> alert('Please try again, Email is required'); window.location='index.php'; </script>";
        }else{
        ...
        if($username && $password){
            $check_username = mysqli_query($connection, "SELECT * FROM users WHERE email = '$username'");//ok
